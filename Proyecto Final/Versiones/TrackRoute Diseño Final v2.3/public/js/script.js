...
document.querySelector('a[href="#produc"]').addEventListener('click', function(e) {
    e.preventDefault(); // Evitar el comportamiento predeterminado del enlace
    document.querySelector('#produc').scrollIntoView({
        behavior: 'smooth',
        block: 'start',
        inline: 'nearest',
...
function agregarAlCarrito(e) {
    ...
    if (rutaActual.includes("http://localhost:8080/users/index")) {
        if(rutaActual.includes("http://localhost:8080/")){
