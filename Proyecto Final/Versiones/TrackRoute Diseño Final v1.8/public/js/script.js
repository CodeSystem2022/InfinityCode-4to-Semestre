...
function usuarioAutenticado() {
    ...
    // Puedes usar el estado de autenticación de tu aplicación, cookies o almacenamiento local, o cualquier otro método que estés utilizando para la autenticación.
    // Devuelve true si el usuario está autenticado, de lo contrario, devuelve false.
}

// Agregar un event listener a los botones "Agregar al carrito"
botonesAgregar.forEach(boton => {
    boton.addEventListener("click", function (e) {
        ...
        if (usuarioAutenticado()) {
            // El usuario está autenticado, puedes agregar el producto al carrito
            agregarAlCarrito(e);
        } else {
            // El usuario no está autenticado, redirígelo al inicio de sesión o registro
            window.location.href = "/users/login"; // Reemplaza "/users/login" con la URL correcta de tu página de inicio de sesión.
        }
    });
});
